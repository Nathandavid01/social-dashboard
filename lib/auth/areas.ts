...
export const AREAS: Area[] = [
  ...
  // Estudio del editor: subir video → IA → caption → borrador Metricool (no se publica solo).
  { href: '/subir-video',        label: 'Subir video',     permission: 'metricool.draft',    group: 'Trabajo' },
