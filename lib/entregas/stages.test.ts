...
import { computeStage, bucketByStage, adjacentStage, stageToStatus, ENTREGA_STAGES, type StageInput } from './stages'
...
describe('bucketByStage', () => {
  it('groups cards into the 4 columns and preserves order', () => {
    ...
    expect(Object.keys(b)).toEqual(ENTREGA_STAGES.map((s) => s.key))
