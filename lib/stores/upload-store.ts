...
export const TERMINAL_UPLOAD_PHASES: ReadonlySet<UploadPhase> = new Set([
  'listo',
  'error',
  'cancelado',
  'duplicado',
...
export interface UploadItem {
   ...
   * no bloquea "listo". Ausente en fases anteriores.
   */
...
export const useUploadStore = create<UploadStoreState>((set, get) => ({
  ...
  hasActiveUploads() {
    return Object.values(get().uploads).some((u) => !TERMINAL_UPLOAD_PHASES.has(u.phase))
  },
}))
