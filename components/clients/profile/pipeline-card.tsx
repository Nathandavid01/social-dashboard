...
export function PipelineCard({ data, title, linkable, clientId }: Props) {
  ...
  const steps: Step[] = [
    { key: 'ideas',       label: 'Ideas',        value: data.ideas,        icon: Lightbulb,     tone: 'text-purple-600 bg-purple-500/10 border-purple-500/25', iconBg: 'bg-purple-500/15 text-purple-600', href: `/onsite${q}` },
