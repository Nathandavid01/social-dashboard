...
- [ ] **`0083_client_posting_timezone.sql`** — columna `clients.posting_timezone`. Sin ella, días/hora/horario por día siguen funcionando; la zona no se guarda hasta aplicarla (el editor degrada y omite el campo).
