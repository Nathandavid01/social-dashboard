...
- [x] **`0041_caption_feedback.sql`** — tabla `caption_feedback` aplicada en **staging** (`mnqgesxmtsxtsajxfesy`). En **prod** (`bgqdtfhelknmfudcvrzz`) sigue pendiente: sin ella, generar funciona y **guardar un voto** 👍/👎 falla.
